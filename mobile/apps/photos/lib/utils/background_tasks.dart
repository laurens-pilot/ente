...
class BackgroundTasks {
  ...
  static Future<void> _configure() async {
    final useNative = flagService.internalUser;
    final allowRefresh =
        ...
        if (allowRefresh)
          BackgroundTaskConfig(
            ...
            runBudget: Platform.isIOS
                ...
                : BgTaskUtils.mlSelfStopFor(BgTaskUtils.androidPeriodicTask),
          ),
        BackgroundTaskConfig(
          ...
          initialDelay: Platform.isIOS && !kDebugMode
              ? const Duration(minutes: 30)
              : Duration.zero,
          flexInterval: Platform.isAndroid ? const Duration(hours: 2) : null,
    ...
    if (useNative) {
      final holder = await ProcessLockClient.instance.state(
        name: "background_process",
      );
      if (holder == null) await retireLegacySchedules();
    } else {
